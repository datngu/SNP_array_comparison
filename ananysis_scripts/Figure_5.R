...
setwd("/media/datn/data2gb/GitHub/SNP_array_comparsion/pmra_real_data")
...
pdf(file= "../Figure_5.pdf",  width=8, height=6)
p1
dev.off()
...
write.csv(stat_df, file = "Imputation_acc_real_simulated_PMRA.csv", quote = F, row.names = F)
